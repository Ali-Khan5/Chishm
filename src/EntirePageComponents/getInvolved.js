      ...
      <Grid fluid>
            ...
            > <h3><i style={{ fontSize: "45px" }} className="fas fa-hand-holding-usd"></i></h3>
              ...
              <p>
               ...
               . Our idea is to find a
                ...
                mentees family is also compensated with household expenses if it
                prevents the mentee being part of child-labour. For our open
                sponsorship positions please send us an email and we will get
        ...
        <Row>
          <Col md={8} mdOffset={2}>
            ...
            >
            <h3><i style={{ fontSize: "45px" }} className="fas fa-handshake"></i></h3>
        ...
        <Row>
          <Col md={8} mdOffset={2}>
            ...
            >
            <h3><i style={{ fontSize: "45px" }} className="fas fa-chalkboard-teacher"></i></h3>
        ...
        <Col md={6} mdOffset={3}>
            ...
            >
            <h3><i style={{ fontSize: "45px" }} className="fas fa-wrench"></i></h3>
              <h3> Help us improve </h3>
              <p>
              We always welcome feedback from people on how to improve our operations, programs and projects. If you have any feedback or suggestions, please send us an email. 
